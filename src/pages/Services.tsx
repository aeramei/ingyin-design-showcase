...
const Services = () => {
  const services = [{
    ...
    features: ["User research and persona development", "Information architecture and user flows", "Wireframing and low-fidelity prototypes", "High-fidelity visual design", "Interactive prototypes", "Design system creation"],
    tools: ["Figma", "Adobe XD", "Sketch", "InVision"],
    price: "Starting from $500"
  }, {
    title: "Wireframing & Prototyping",
    description: "Detailed wireframes and interactive prototypes to validate ideas before development.",
    features: ["Low and high-fidelity wireframes", "Interactive clickable prototypes", "User journey mapping", "Usability testing preparation", "Stakeholder presentation materials", "Documentation and annotations"],
    ...
    features: ["User interviews and surveys", "Competitive analysis", "Persona development", "User journey mapping", "Usability testing", "Research insights and recommendations"],
    ...
    features: ["Responsive web design", "HTML, CSS, JavaScript development", "Cross-browser compatibility", "Performance optimization", "SEO-friendly markup", "Content management integration"],
      ...
      <main className="pt-20">
        ...
        <section className="max-w-6xl mx-auto px-6 pb-16">
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service, index) => <div key={service.title} className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300">
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {service.tools.map(tool => <span key={tool} className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium">
                          {tool}
                        </span>)}
                    </div>
                  </div>
